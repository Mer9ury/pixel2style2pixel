...
from models.encoders.psp_encoders import GradualStyleBlock
...
class ProgressiveBackboneEncoder(Module):
    ...
    """
    def __init__(self, num_layers, mode='ir', n_styles=14, opts=None):
...
class ResNetProgressiveBackboneEncoder(Module):
    ...
    progressive training scheme from e4e_modules.
    """
    def __init__(self, n_styles=14, opts=None):
